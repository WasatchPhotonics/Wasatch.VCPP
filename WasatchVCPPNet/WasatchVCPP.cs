...
class WasatchVCPP
{
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int wp_set_tec_enable(int specIndex, int value);
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int wp_set_high_gain_mode(int specIndex, int value);
